...
class ErrorResponseTests {
    ...
    @Test
    void testDifferentCodesNotEqual() {
        ErrorResponse response1 = new ErrorResponse("400", "Error", null);
        ErrorResponse response2 = new ErrorResponse("500", "Error", null);
        assertNotEquals(response1, response2);
    }

    @Test
    void testDifferentMessagesNotEqual() {
        ErrorResponse response1 = new ErrorResponse("400", "Error 1", null);
        ErrorResponse response2 = new ErrorResponse("400", "Error 2", null);
        assertNotEquals(response1, response2);
    }

    @Test
    void testDifferentDetailsNotEqual() {
        ErrorResponse response1 = new ErrorResponse("400", "Error", "details1");
        ErrorResponse response2 = new ErrorResponse("400", "Error", "details2");
        assertNotEquals(response1, response2);
    }
}
